...
public class AcidLightActivator : MonoBehaviour
{
    private Light2D lightSource;
    public float targetIntensity = 4f;
    public float minIntensity = 0f;
    public float intensityChangeDuration = .5f;
    ...
    void Start()
    {
        lightSource = GameObject.FindGameObjectWithTag("Acid Light Source").GetComponent<Light2D>();
